...
public class HighPressureDecorator extends BaseDecorator<DeviceMeasurement> {
    public HighPressureDecorator(Component<DeviceMeasurement> component) {
        super(component);
    }
